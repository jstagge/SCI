...
sci_mle <- function(x_ts, resolution, distr, p0, warn, start.fun, start.fun.fix, ref_years){
  ...
  x_fit <- sapply(timestep_list, sci_mle_j, x_ts = x_ts, x_res = resolution, distr = distr , p0 = p0, warn = warn, start.fun = start.fun, start.fun.fix = start.fun.fix)
...
#' @return An Lmoment fit.
#' @export
sci_mle_j <- function(j, x_ts, distr, x_res, p0, warn = TRUE, start.fun, start.fun.fix = FALSE){
